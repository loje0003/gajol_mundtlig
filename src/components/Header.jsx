  ...
  return (
    <div className="relative w-full h-150">
      ...
      <div className="absolute inset-0 flex flex-col items-center justify-center gap-5">
        ...
        <motion.h3 variants={fadeSlide} initial="hidden" animate="show" transition={{ duration: 0.5, delay: 0.7 }} className="text-[15px] tracking-[1em] md:text-[30px] md:tracking-[0.65em] uppercase text-center">
          have a good time
        </motion.h3>

        <motion.div variants={fadeSlide} initial="hidden" animate="show" transition={{ duration: 0.5, delay: 0.7 }}>
          <Image src="/assets/bottom_line.png" alt="bottom line" width={500} height={30} />
        </motion.div>

        <motion.div variants={fadeSlide} initial="hidden" animate="show" transition={{ duration: 0.5, delay: 0.7 }} className="grid grid-cols-2 gap-5 mt-5">
          <Link href="/events">
